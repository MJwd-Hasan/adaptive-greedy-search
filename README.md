...
|---|---|---|
| `cv` | `5` | Number of CV folds. Pruning is far more effective at `5` or `10` — with `3` there's barely a checkpoint before the last fold (3 was fixed in the earlier version). |
